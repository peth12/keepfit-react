    ...
    <>
        <button
            ...
            >
                ...
                <button className="p-1 px-3 rounded-lg items-center gap-1 bg-red-500 hover:bg-red-600 text-white flex">Delete<RiDeleteBin6Line/></button>
            ...
            >
              <div className="modal-box">
                ...
                <p className="py-4 text-center">
                  Deleting this <strong>User</strong> will permanently remove it from the record. Are you sure you want to delete this User?
                </p>
