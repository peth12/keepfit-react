...
export const LandingPage = () => {
      ...
      <div className="flex-col ">
        ...
        <section className="w-full h-auto bg-gradient-to-r from-red-500 to-amber-500 relative overflow-x-hidden">
          <main className="w-full lg:h-screen md:h-[50vh] h-screen relative bg-zinc-900 overflow-x-hidden pt-[60px] ">
            ...
            <div className="md:w-[50%] w-full md:h-full h-1/2 absolute md:top-0 top-1/2 right-0 backdrop-blur-md bg-opacity-30 bg-gray-800 flex flex-col md:justify-center justify-start lg:gap-8 md:gap-4 gap-2 lg:px-20 md:px-6 px-4 overflow-x-hidden">
  <h1 className="lg:text-6xl md:text-4xl text-4xl md:mt-10 mt-10 text-zinc-100 font-extrabold flex italic">
    <Slide direction="right">
      <span className="text-[#303030]">Keep</span>{" "}
      <span className="text-zinc-100">Fit</span>
    </Slide>
  </h1>
  <p className="lg:text-lg text-base text-zinc-400 my-4">
    <Slide direction="left">
      "The Only Bad Workout is the One That Didn't Happen. Commit to Your Health, Fuel Your Fire, and Conquer Your Limits."
    </Slide>
  </p>
  <div className="flex items-center gap-8">
    ...
    <div className="flex gap-2">
      <Slide direction="up">
        <p className="text-white hidden md:block">Do you have an account?</p>
        <a
          href="Login"
        ...
        <section className="w-full h-auto flex items-center bg-zinc-950">
          <main className="w-full md:h-[700px] grid md:grid-cols-2 items-start lg:mx-20 md:mx-10 mx-6 gap-10 md:gap-10 py-12 md:py-0">
            <div className="h-full w-full md:order-1 order-2 flex flex-col justify-start items-start gap-4 pb-8 md:pb-12">
              <Fade>
                ...
                <p className="text-zinc-400 text-justify text-2xl">
