    ...
    <>
      ...
      <div className="flex-col ">
        ...
        <section className="w-full h-auto flex items-center bg-zinc-950">
          <main className="w-full  grid md:grid-cols-2 items-start lg:mx-20 md:mx-10 mx-6 gap-10 md:gap-10 py-12 md:py-0">
            <div className="h-full w-full md:order-1 order-2 flex flex-col justify-start items-start gap-4 ">
              <Fade>
            ...
            <div className="w-full  md:order-2 order-1 p-10">
              <img
